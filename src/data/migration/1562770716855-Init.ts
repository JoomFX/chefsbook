...
export class Init1562770716855 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query("CREATE TABLE `subrecipe` (`id` varchar(36) NOT NULL, `isDeleted` tinyint NOT NULL DEFAULT 0, `recipeId` varchar(36) NULL, PRIMARY KEY (`id`)) ENGINE=InnoDB");
